...
int main() {
 float n1, n2;
 bool salida;
    cout << "\nMuestra en pantalla True o False si la edad ingresada por dos usuarios es la misma: \n";//función del Prográma
    cout << "\nIngrese la edad del usuario #1: ";
    cin >> n1 ;
        cout << "Ingrese la edad del usuario #2: ";
    cin >> n2;
      if (n1==n2){
       cout << "\n¿La edad del usuario #1 y #2 es la misma? : " <<"True";
   return 0;
  }
